...
class ZFE_Cache_Backend_Redis extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface
{
     ...
     * Log message
     */
    const TAGS_UNSUPPORTED_BY_CLEAN_OF_REDIS_BACKEND = 'ZFE_Cache_Backend_Redis::clean() : tags are unsupported by the Redis backend';
    const TAGS_UNSUPPORTED_BY_SAVE_OF_REDIS_BACKEND = 'ZFE_Cache_Backend_Redis::save() : tags are unsupported by the Redis backend';
    const FILLING_PERCENTAGE_UNSUPPORTED_OF_REDIS_BACKEND = 'ZFE_Cache_Backend_Redis::getFillingPercentage() : method unsupported by the Redis backend';
    ...
    public function clean($mode = Zend_Cache::CLEANING_MODE_ALL, $tags = array())
    {
        switch ($mode) {
            ...
            case Zend_Cache::CLEANING_MODE_OLD:
                $this->_log("ZFE_Cache_Backend_Redis::clean() : CLEANING_MODE_OLD is unsupported by the Redis backend");
                break;
